...
> Spec: [specs/mock-erp/spec.md](spec.md)
> File: `/app/mock_erp.py`

---

## 1. Orders 数据初始化

- [x] 1.1 实现 orders 字典，包含 3 条样本数据
...
- [x] 2.1 实现 inventory 字典，包含 2 条样本数据，available 自动计算
...
- [x] 3.1 实现 suppliers 字典，包含 2 条样本数据
...
## 4. Order Counter 自增 ID

- [x] 4.1 实现 order_counter 字典与自增函数
...
- [x] 6.1 实现库存预留函数（创建订单时调用）
- [x] 6.2 实现库存释放函数（取消订单时调用）
